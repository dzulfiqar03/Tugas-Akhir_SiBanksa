...
//     // Kumpulkan data DB sebagai context untuk Groq
//     if (in_array('setoran', $matches)) {
//         if ($userDetail->id_roles === 2) {
//             $total = PencatatanSetoran::where('id_userdetail', $userDetail->id)
//                 ->sum('total_setoran');

//             $bulanIni = PencatatanSetoran::where('id_userdetail', $userDetail->id)
...
//     // Kirim ke Groq (dengan atau tanpa keyword match)

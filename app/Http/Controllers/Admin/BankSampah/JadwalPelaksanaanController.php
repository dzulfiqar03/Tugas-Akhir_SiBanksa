...
class JadwalPelaksanaanController extends Controller
{
    ...
    {
        $result = $this->jadwalServices->createJadwal($request->validated());
        if ($result) {
    ...
    {
        $result = $this->jadwalServices->updateJadwal($Jadwal->id, $request->validated());
        if ($result) {
    ...
    {
        $result = $this->jadwalServices->deleteJadwal($Jadwal->id);
        if ($result) {

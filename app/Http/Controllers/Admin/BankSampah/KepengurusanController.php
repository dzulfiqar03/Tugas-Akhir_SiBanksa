...
class KepengurusanController extends Controller
{
    ...
    {
        $result = $this->kepengurusanServices->createKepengurusan($request->validated());
        if ($result) {
    ...
    {
        $result = $this->kepengurusanServices->updateKepengurusan($id, $request->validated());
        if ($result) {
            return redirect()->back()->with('message', 'Kepengurusan berhasil ditambahkan');
        } else {
    ...
    {
        $result = $this->kepengurusanServices->deleteKepengurusan($id);
        if ($result) {

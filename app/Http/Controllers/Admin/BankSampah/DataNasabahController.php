...
class DataNasabahController extends Controller
{
    ...
    {
        $result = $this->nasabahServices->createNasabah($request->validated());
        if ($result) {
    ...
    {
        $result = $this->nasabahServices->updateNasabah($id, $request->validated());
        if ($result) {
    ...
    {
        $result = $this->nasabahServices->deleteNasabah($id);
        if ($result) {

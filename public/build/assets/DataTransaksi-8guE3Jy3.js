import{u as ce,g as o,a as C,b,h as pe,w as B,o as n,d as t,F as v,c as xe,l as ge,f as g,i as _,n as D,j as H,t as c,K as me,T as be,_ as fe,v as ke,q as A,e as ye,B as z,C as M,r as I,y as he}from"./app-BrcfjX35.js";import{_ as we}from"./AuthenticatedLayout-C0onv4fe.js";import{j as ve,v as E,b as _e}from"./vfs_fonts-C-qJnSL_.js";import{_ as Ce}from"./InputLabel-JS9hr2We.js";import{V as S,D as R}from"./datatables.net-vue3-BeRdv_a7.js";import"./responsive.dataTables-BwW5rpoL.js";import{_ as De}from"./_plugin-vue_export-helper-DlAUqK2U.js";/* empty css            */import"./Preloader-BdOnNCfV.js";import"./404-DjxopeoY.js";import"./SessionExpired-DN5ZUSSL.js";/* empty css                                                               */import"./_commonjs-dynamic-modules-TDtrdbi3.js";const Se={key:0,class:"card w-full shadow-sm border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden"},Te={class:"flex flex-col gap-5 bg-gray-200 dark:bg-gray-800 transition-colors"},$e={key:0,class:"p-3"},Be={key:0,class:"w-full font-medium capitalize text-gray-700 dark:text-gray-300"},Ie={key:1,class:"w-full font-medium capitalize text-gray-700 dark:text-gray-300"},Ne={key:1,class:"grid gap-4"},Ae={class:"bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border border-gray-200 dark:border-gray-700"},Re={key:0,class:"bg-white accordion-wrapper overflow-hidden dark:bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700"},je={class:"text-lg font-semibold mb-4 text-black dark:text-white"},ze={class:"grid grid-cols-1 gap-4"},Pe={key:0,class:"flex flex-col"},Le=["type","id","placeholder"],Fe={key:0,class:"text-xs text-emerald-600 mt-2 font-medium"},Me={key:1,class:"mt-2 space-y-1"},Ee={class:"md:col-span-2 lg:col-span-3 flex justify-end items-center gap-3 pt-2"},Oe=["disabled"],Ke={class:"grid grid-cols-1 lg:grid-cols-7 gap-4"},He={class:"lg:col-span-5 bg-white dark:bg-gray-800 rounded-xl shadow p-5 overflow-hidden"},Ue={class:"overflow-x-auto"},Ve={class:"flex flex-col lg:flex-row lg:items-end justify-between mb-6"},Ge={class:"flex flex-wrap mb-5 lg:mb-0 items-center gap-2"},We={class:"flex flex-wrap md:flex-nowrap items-end justify-start gap-3"},Je={class:"flex items-end gap-2"},qe={class:"flex items-center gap-2"},Ye={class:"flex items-center gap-2"},Ze={class:"hidden md:block"},Qe={class:"block md:hidden space-y-4"},Xe={key:0,class:"text-[10px] text-gray-500 font-bold uppercase mb-2"},et={class:"flex justify-between items-start mb-3"},tt={class:"flex items-center gap-3"},at={class:"w-10 h-10 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 rounded-full flex items-center justify-center font-bold text-sm"},rt={class:"font-bold text-gray-800 dark:text-white capitalize leading-tight"},st={class:"text-[11px] text-gray-500 mt-0.5 flex items-center gap-2"},nt={key:0},ot={key:1,class:"italic text-gray-400"},lt=["onClick"],it={class:"mt-2 space-y-1"},dt={key:0,class:"flex items-center gap-2"},ut={class:"flex flex-col"},ct={class:"text-[10px] font-bold text-gray-700 dark:text-gray-200"},pt={class:"text-[11px] font-mono text-emerald-600 dark:text-emerald-400"},xt={key:1,class:"flex items-center gap-2 py-1 px-2 bg-gray-50 dark:bg-gray-800/50 rounded-lg w-max"},gt={class:"text-[10px] text-gray-500"},mt={class:"grid grid-cols-1 gap-2 mt-4 pt-3 border-t border-gray-50 dark:border-gray-800"},bt=["onClick"],ft={key:1,class:"flex flex-col gap-2"},kt=["onClick"],yt={key:1,class:"flex flex-col items-center justify-center py-12 text-gray-400 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-800"},ht={key:2,class:"mt-6 flex flex-col items-center gap-4"},wt={class:"text-xs text-gray-500 font-medium"},vt={class:"text-gray-800 dark:text-white font-bold"},_t={class:"text-gray-800 dark:text-white font-bold"},Ct={class:"flex items-center gap-2 w-full"},Dt=["disabled"],St=["disabled"],Tt={class:"flex gap-1.5"},$t={class:"lg:col-span-2 bg-gray-50 dark:bg-gray-700 rounded-xl shadow p-5"},Bt={class:"overflow-x-auto"},It=["onClick"],Nt={class:"py-2"},At={class:"border-gray-100 w-max dark:border-gray-800"},Rt={key:0,class:"profile-circle py-1 px-2 rounded-full border border-gray-600 text-gray-800 dark:text-white"},jt={key:1,class:"profile-circle"},zt={class:"py-2 font-medium text-black dark:text-white"},Pt={__name:"DataTransaksi",props:{formdata:Object,items:Array,sidebardata:Object,document:Array,breadcrumbItems:Array,user:Object,transaction:Array,nasabah:Array,nasabahAll:Array,reporting:Array,countTransaction:Number,IDRW:Number,IDRT:Number},setup(j){S.use(R),S.use(R),S.use(R),S.use(R),S.use(R),window.JSZip=ve;const U=E.pdfMake?E.pdfMake.vfs:E.vfs;_e.vfs=U;const p=j;console.log(p.nasabah);const k=I(!1),P=I(!1),i=ce({id:p.user.id,id_userdetail:p.user.user_detail.id,id_jadwal:"",fullName:"",pencatatan_setoran_id:"",bukti_pembayaran:"",fileDoc:[]}),V=r=>{z.get(route("show-nasabah",r))},G=M(()=>i.fileDoc.map((r,e)=>{const a=r.name.split(".").pop();return{original:r.name,dynamic:`Bukti_Pembayaran_${i.fullName.replace(" ","_")}_BankSampahRT0${p.IDRT}.${a}`,size:r.size}})),O=r=>{let e;if(typeof r=="string")try{e=JSON.parse(decodeURIComponent(escape(atob(r))))}catch(a){console.error("Gagal mendecode Base64:",a);return}else e=r;console.log("Data yang akan diedit:",e),P.value=!0,i.id=e.user_detail?.id_user,i.fullName=e.user_detail?.fullName,i.id_userdetail=e.id_userdetail,i.id_jadwal=e.id_jadwal,i.pencatatan_setoran_id=e.pencatatan_items?.find(a=>a.pencatatan_setoran_id)?.pencatatan_setoran_id??null,i.bukti_pembayaran="",k.value=!0,window.scrollTo({top:0,behavior:"smooth"})};window.uploadBukti=O;const K=r=>{const e=JSON.parse(decodeURIComponent(escape(atob(r))));Swal.fire({title:"Hapus data?",text:"Tindakan ini tidak bisa dibatalkan!",icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",confirmButtonText:"Ya, Hapus!"}).then(a=>{a.isConfirmed&&z.delete(route("bs.delete-transaction",e.id),{onSuccess:()=>Swal.fire("Dihapus!","Data berhasil dihapus.","success")})})};window.handleDelete=K;const W=r=>{const e=JSON.parse(decodeURIComponent(escape(atob(r))));Swal.fire({title:"Lakukan Pembukaan Transaksi?",text:"Bank sampah RT0"+p.IDRT+" akan dapat melakukan transaksi dan notifikasi mengenai pelaporan anda",icon:"question",showCancelButton:!0,confirmButtonColor:"#ef4444",confirmButtonText:"Ya, Kirim!"}).then(a=>{a.isConfirmed&&z.post(route("bs.chat-transaction",e.user_detail.id_user),{message:"Anda Belum mengisi rekening dan tidak bisa dicairkan, Isi dan lengkapi rekening terlebih dahulu!!"},{onSuccess:()=>{Swal.fire("Terkirim!","Pesan pengingat telah dikirim.","success"),window.location.reload()}})})};window.handleWA=W;const y=he(),J=M(()=>y.props.auth.user),w=I(null),N=I([]),h=I({page:0,pages:0,start:0,end:0,recordsDisplay:0}),q=r=>{r&&(N.value=r.rows({search:"applied",page:"current"}).data().toArray(),h.value=r.page.info())},Y=M(()=>(p.nasabah.some(r=>r.user_detail?.pencairan_via==="Tunai"),{pageLength:5,responsive:!0,lengthMenu:[5,10,25,50],drawCallback:function(){const r=this.api();q(r)},columns:[{data:null,render:(r,e,a,s)=>s.row+1},{data:"user_detail.fullName",render:(r,e,a)=>`<div class="capitalize">${a.user_detail.fullName||"-"}</div>`,defaultContent:"-"},{data:"user_bank",render:(r,e,a)=>{if(!a.user_bank||a.user_bank.length===0)return'<span class="text-gray-400">-</span>';const s=a.user_bank[0].nomor_rekening,l=s.length>7?s.slice(0,4)+" •••• "+s.slice(-3):"••••"+s.slice(-3);return`
...
`},{columns:[{text:"",width:"*"},{width:180,stack:[{text:`Gresik, ${new Date().toLocaleDateString("id-ID",{day:"numeric",month:"long",year:"numeric"})}`,alignment:"center"},{text:"Verifikator Lapangan",alignment:"center",margin:[0,5,0,40]},{text:`( ${l?.fullName||".........................."} )`,alignment:"center",bold:!0},{text:"ID: SBK-RT0"+d,alignment:"center",fontSize:8,color:"#9ca3af"}]}]}),r.styles.tableHeader={fillColor:"#10b981",color:"white",bold:!0,alignment:"center"}}},{extend:"excelHtml5",text:'<i class="fa-solid fa-file-excel mr-2"></i> Excel',className:"export-btn bg-emerald-500 hover:bg-emerald-600 text-white px-3 py-1.5 rounded-md text-sm shadow-sm",title:"Dokumen Transaksi SiBanksa RT-0"+(y.props.auth.user.user_detail?.id_rt||"-")+" "+new Date().toLocaleDateString("id-ID").replace(/\//g,"-"),exportOptions:{columns:":not(.no-print)"},customize:function(r){var e=r.xl.worksheets["sheet1.xml"];const a=p.nasabah?.reduce((x,m)=>{const f=m.pencatatan_items?.reduce((F,ue)=>F+(parseFloat(ue.subtotal)||0),0)||0;return x+f},0);$("row c",e).attr("s","25"),$("row:first c",e).attr("s","51");var s=[{id:"A",width:5},{id:"B",width:30},{id:"C",width:20},{id:"D",width:15},{id:"E",width:20},{id:"F",width:15}];s.forEach((x,m)=>{$(`col[min="${m+1}"]`,e).attr("width",x.width)});var l=$("row",e).length,d=l+1,u=`
    ...
    `;$("sheetData",e).append(u),$("mergeCells",e).length||$("worksheet",e).prepend('<mergeCells count="1"/>'),$("mergeCells",e).append(`<mergeCell ref="A${d}:D${d}"/>`)}},{extend:"print",text:'<i class="fa-solid fa-print mr-2"></i> Print',className:"export-btn bg-gray-700 hover:bg-gray-800 text-white px-3 py-1.5 rounded-md text-sm shadow-sm",title:"",customize:function(r){const e=p.nasabah?.reduce((l,d)=>{const u=d.pencatatan_items?.reduce((x,m)=>x+(parseFloat(m.subtotal)||0),0)||0;return l+u},0),a=new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0}).format(e),s=p.nasabah?.map((l,d)=>{const u=l.pencatatan_items?.reduce((m,f)=>m+(parseFloat(f.subtotal)||0),0)||0,x=new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0}).format(u);return`
            <tr style="border-bottom: 1px solid #f3f4f6;">
                <td style="padding: 12px; text-align: center;">${d+1}</td>

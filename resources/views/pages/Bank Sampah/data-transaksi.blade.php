                ...
                <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                    ...
                    <div class="flex flex-col md:col-span-5 bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="overflow-x-auto">
                            ...
                            @section('tbhead-transaksi')
                                <th class=" text-gray-800 dark:text-white">No</th>
                                <th class=" text-gray-800 dark:text-white">Nama Lengkap</th>
                                <th class=" text-gray-800 dark:text-white">Total Hasil Setoran</th>
                                <th class=" text-gray-800 dark:text-white">Status</th>
                                <th class="no-print text-center text-gray-800 dark:text-white">Aksi</th>
                            @endsection
                            ...
                            @include('components.tailwind-admin.data-tables', ['titleTable' => 'dataTransaksi'])
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-5 md:col-span-2 bg-gray-50 dark:bg-gray-700 rounded-lg shadow p-6">
                        ...
                        <div class="overflow-x-auto">
                            ...
                            @include('components.tailwind-admin.data-tables', ['titleTable' => 'dataRekening'])
                        </div>
                    </div>
                </div>

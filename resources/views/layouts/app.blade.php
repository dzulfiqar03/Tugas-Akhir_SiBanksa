...
<head>
    ...
    @if (in_array($currentRouteName, ['register']))
        <style>
            input::placeholder {
                font-size: 10px
            }
...
<body x-data="{
    ...
    stickyMenu: false,
    scrollTop: false
}" x-init="initTheme()" class="bg-gray-100 dark:bg-gray-900 flex min-h-screen">
    ...
    @if ($currentRouteName === 'check-internet')
        @include('components.tailwind-admin.404')
    @else
            ...
            <div class="flex-1 flex flex-col transition-all duration-300">
                ...
                <main class="p-6 flex-1">
                    @if ($currentRouteName == 'dashboard')
                        @yield('dashboard')
                    @elseif ($currentRouteName == 'warga.dashboard')
                        @yield('dashboard')
                ...
                <div class="relative flex flex-col justify-center w-full h-max  sm:p-0 lg:flex-row">
                    <div class="p-5 ">
                        ...
                        @elseif ($currentRouteName == 'register')
                            ...
                            @vite('resources/js/services/dataReader.js')
                        @endif
                    </div>
    ...
    <div class="fixed z-50 bottom-6 right-6 sm:block">
        <button @click="toggleDarkMode()"
            ...
            <svg class="dark:hidden fill-current block" width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <svg class="dark:block fill-current hidden" width="20" height="20" viewBox="0 0 20 20" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path

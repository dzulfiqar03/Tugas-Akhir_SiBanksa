...
<template>
    <GuestLayout>
                        ...
                        <div class="transform scale-90 flex w-max items-center gap-3">
                            ...
                            <a
                                ...
                                <span @click="showUsername = !showUsername"
                                    class="overflow-hidden text-white font-bold hover:text-emerald-500 dark:text-emerald-500">
                                    Join Us
                                </span>
                            </a>
                        </div>
        ...
        <div class="flex flex-col w-full lg:w-[32rem]">
            ...
            <FormWrapper formName="formRegister" :errors="form.errors" :processing="form.processing" @submit="submit">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="field in filteredFields" :key="field.name"
                            ...
                            <div v-if="field.name === 'rt'" class="col-span-full">
                                ...
                                <select v-model="form[showForm === 'BankSampah' ? 'bankSampah' : 'nasabah'].id_rt"

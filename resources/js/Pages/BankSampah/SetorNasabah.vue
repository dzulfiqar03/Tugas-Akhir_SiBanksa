    ...
    <AuthenticatedLayout :sidebardata="sidebardata" :breadcrumbItems="breadcrumbItems">
        <div class="space-y-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Manajemen Waktu Perjanjian Penyetoran
                        Nasabah</h2>
            ...
            <div
                ...
                <DataTable ref="dtInstance" :data="janjiList" :options="dtOptions"

...
<template>
  ...
  <AuthenticatedLayout :sidebardata="sidebardata" :breadcrumb-items="breadcrumbItems">
    ...
    <div class="max-w-6xl mx-auto px-4 py-10 space-y-10">
      ...
      <!-- ================= TIMELINE ================= -->
      <div v-if="selectedSetoran"
           class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-8">
        ...
        <div class="hidden md:flex justify-between relative">
          ...
          <template v-for="(step, index) in timelineSteps" :key="index">
            ...
            <div class="flex-1 text-center relative">
              ...
              <div
                class="w-12 h-12 mx-auto rounded-full flex items-center justify-center text-white font-bold relative z-10 transition-all"
                :class="{
      ...
      <div>
        ...
        <div v-else
             class="text-center py-16 bg-white dark:bg-gray-800 rounded-xl shadow">

        ...
        >
               <div  class="flex flex-wrap items-center w-full gap-4 mb-8">
                ...
                <div class="flex items-center gap-2 cursor-pointer" @click="step = 4">
                    <span :class="step >= 4 ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-500'" class="w-8 h-8 flex items-center justify-center rounded-full text-xs font-bold transition-all">4</span>
                    <span :class="step >= 4 ? 'text-emerald-700' : 'text-gray-400'" class="text-[10px] font-bold uppercase tracking-widest">Transaksi</span>
                </div>
            </div>
...
<div v-else-if="field.type !== 'file' && field.name !== 'rt' && field.name !== 'status'"
     class="col-span-1">
            ...
            isEdit === true?'border-white dark:border-gray-700':'border-gray-200 dark:border-gray-700'
                ...
                <button v-if="isEdit === false" type="button" @click="step = 3" class="  px-12  py-3 bg-emerald-600 text-white rounded-xl font-bold">Lanjut -></button>
            ...
            isEdit === true?'border-white  dark:border-gray-700':'border-gray-200 dark:border-gray-700'
                 ...
                 <div v-if="isEdit === false" class="flex justify-between gap-4">
                    <button type="button" @click="step = 2" class="text-gray-400 text-sm font-bold">Kembali</button>
                                    ...
                                    <button v-if="isEdit === false" type="button" @click="step = 4" class="w-max px-12 py-3 bg-emerald-600 text-white rounded-xl font-bold">Lanjut</button>
                </div>
            </div>
...
@keyup="bankIdentify"
            ...
            isEdit === true?'border-white  dark:border-gray-700':'border-gray-200 dark:border-gray-700'
                 ...
                 <div v-if="isEdit === false" class="flex justify-between gap-4">
                    <button type="button" @click="step = 3" class="text-gray-400 text-sm font-bold">Kembali</button>

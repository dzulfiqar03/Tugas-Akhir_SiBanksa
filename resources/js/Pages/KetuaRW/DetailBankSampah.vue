        ...
        <div class="space-y-6">
            <div
                ...
                <div class="flex justify-between">
                    ...
                    <button @click="sendReminder(nasabah.id)"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="flex items-center gap-2">
                            <p class="text-black dark:text-gray-300">
                                {{ nasabah.user_detail.telephone_number !== null ? (showNumber ?
                                    nasabah.user_detail.telephone_number : maskPhone(nasabah.user_detail.telephone_number))
                                    ||
                    ...
                    <div class="space-y-1 md:col-span-2">
                        ...
                        <p class="dark:text-gray-300 text-black">
                            {{ nasabah.user_detail.address || 'Alamat belum lengkap' }}</p>
                    </div>
                </div>
            </div>

            <div
                class="bg-white p-3 dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="overflow-x-auto">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
                        <div class="overflow-x-auto">
                            <DataTable ref="dtInstance" :data="items" :options="dtOptions"
                                ...
                                <tbody class="divide-y dark:divide-gray-700 font-medium ">
                                    <tr v-for="(field, index) in allNasabah" :key="index" class="dark:text-gray-300">
                                        ...
                                        <td class="px-6 py-4 text-black dark:text-white">
                                            ...
                                            <span class="hidden invisible text-black dark:text-white">{{
                                                field.user_detail.id_gender == 1 ? 'Pria' : 'Wanita' }}</span>
                                        </td>
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="w-32 bg-gray-200 rounded-full h-2 dark:bg-gray-700">
                                                    <div class="h-2 rounded-full transition-all duration-700 text-black dark:text-white"
                                                        ...
                                                        :style="{ width: field.profile_completion.percentage + '%' }">
                                                    </div>
                                                </div>
                                                <span class="text-xs font-bold text-black dark:text-white">{{
                                                    Math.round(field.profile_completion.percentage) }}%</span>
                                            </div>
                                            <p v-if="field.profile_completion.percentage < 100"
                                                class="text-[10px] text-red-500 mt-1 italic font-normal">
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="w-32 bg-gray-200 rounded-full h-2 dark:bg-gray-700">
                                                    <div class="h-2 rounded-full transition-all duration-700 text-black dark:text-white"
                                                        ...
                                                        :style="{ width: field.document_completion.percentage + '%' }">
                                                    </div>
                                                </div>
                                                <span class="text-xs font-bold text-black dark:text-white">{{
                                                    Math.round(field.document_completion.percentage) }}%</span>
                                            </div>
                                            <p v-if="field.document_completion.percentage < 100"
                                                class="text-[10px] text-red-500 mt-1 italic font-normal">
